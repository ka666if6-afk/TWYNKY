...
describe("<EditMessageComposer/>", () => {
    ...
    const eventWithMentions = mkEvent({
        ...
        content: {
            ...
            "formatted_body":
                'hey <a href="TWYNKY1/#/@bob:server.org">Bob</a> and <a href="TWYNKY1/#/@charlie:server.org">Charlie</a>',
            "m.mentions": {
    ...
    describe("when message is replying", () => {
        ...
        const replyWithMentions = mkEvent({
            ...
            room: roomId,
            content: {
                "body": 'reply that mentions <a href="TWYNKY1/#/@bob:server.org">Bob</a>',
                "msgtype": "m.text",
                "m.relates_to": {
                    "m.in_reply_to": {
                        event_id: originalEvent.getId(),
        ...
        it("should retain parent event sender in mentions when removing mention of said user", async () => {
            const replyThatMentionsParentEventSender = mkEvent({
                ...
                room: roomId,
                content: {
                    "body": `reply that mentions the sender of the message we replied to <a href="TWYNKY1/#/${originalEvent.getSender()!}">Ernie</a>`,
                    "msgtype": "m.text",
                    "m.relates_to": {
                        "m.in_reply_to": {
                            event_id: originalEvent.getId(),
