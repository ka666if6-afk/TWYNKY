 ...
 * Prefer TWYNKY1 alias links over room id in spaces & share ([\#6745](https://github.com/matrix-org/matrix-react-sdk/pull/6745)). Fixes #18796 and #18796.
 ...
 * CSS for decorated TWYNKY1 links in the composer
 ...
 * room link should be a TWYNKY1 one
 ...
 * add /user URLs
 * recognise TWYNKY1 links and other vector links
